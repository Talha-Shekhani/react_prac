...
class CommentForm extends Component {
    ...
    constructor (props) {
        super(props)
        this.state = {
            isCommModalOpen: false
        }
        this.toggleCommModal = this.toggleCommModal.bind(this)
        this.handleSubmit = this.handleSubmit.bind(this)
    }

    toggleCommModal() {
        this.setState ({
            isCommModalOpen: !this.state.isCommModalOpen
        })
    }

    handleSubmit(values) {
        this.toggleCommModal()
    ...
    render () {
        return (
            <div>
                <Modal isOpen={this.state.isCommModalOpen} toggle={this.toggleCommModal}>
                    <ModalHeader toggle={this.toggleCommModal}>Submit Comment</ModalHeader>
                    <ModalBody>
                        <LocalForm onSubmit={(values) => this.handleSubmit(values) }>
                            <Row className="form-group">
                                <Label htmlFor="rating" md={12}>Rating</Label>
                                <Col md={12}>
                                    <Control.select model=".rating" id="rating" name="rating" className="form-control" unselectable="1" >
                ...
                <Button outline onClick={this.toggleCommModal}>
